...
// 1. Add muted attribute to all showcase videos
// Replace <video class="showcase-video... "> with <video class="showcase-video... " muted>
html = html.replace(/<video class="showcase-video([^>]+)>/g, '<video class="showcase-video muted>');

// 2. Inject thumbnail extraction and muted-play logic into the javascript
// Find the video play script section:
// const videos = document.querySelectorAll('.showcase-video');
// const overlays = document.querySelectorAll('.showcase-overlay');

const oldScript = \const videos = document.querySelectorAll('.showcase-video');
                    const overlays = document.querySelectorAll('.showcase-overlay');
...
console.log('Successfully added muted logic and thumbnail extraction script.');
